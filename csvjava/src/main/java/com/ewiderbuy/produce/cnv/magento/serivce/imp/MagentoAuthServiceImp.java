 ...
 */
package com.ewiderbuy.produce.cnv.magento.serivce.imp;

import com.ewiderbuy.produce.cnv.magento.serivce.MagentoAuthService;
import com.ewiderbuy.produce.cnv.magento.MagentoThreeLeggedOAuth;
 ...
 * @author Owner
 */
@Service(value = "magentoAuthService")
public class MagentoAuthServiceImp implements MagentoAuthService {



    public RequestTokenOutDto getRequestToken(ApiTokenInDto apiTokenInDto) {
        OAuthService service = new ServiceBuilder().provider(new MagentoThreeLeggedOAuth(ConstantConfig.MAGENTO_HOST)).
                apiKey(apiTokenInDto.getApiKey()).
                apiSecret(apiTokenInDto.getApiSecret()).
                build();
        ...
        RequestTokenOutDto requestTokenOutDto = new RequestTokenOutDto();
        requestTokenOutDto.setToken(requestToken.getToken());
        requestTokenOutDto.setSecret(requestToken.getSecret());
        requestTokenOutDto.setAuthorizeUrl(authorizeUrl);
        return requestTokenOutDto;
    }

    public RequestTokenOutDto getAcessToken(ApiTokenInDto apiTokenInDto) {
        Token requestToken = new Token(apiTokenInDto.getRequestToken(), apiTokenInDto.getRequestSecret());
        OAuthService service = new ServiceBuilder().provider(new MagentoThreeLeggedOAuth(ConstantConfig.MAGENTO_HOST)).
                apiKey(apiTokenInDto.getApiKey()).
                apiSecret(apiTokenInDto.getApiSecret()).
                build();
        Verifier verifier = new Verifier(apiTokenInDto.getVerifierStr());
        Token accessToken = service.getAccessToken(requestToken, verifier);
        System.out.println("accessToken = " + accessToken);

        RequestTokenOutDto accessTokenOutDto = new RequestTokenOutDto();
        accessTokenOutDto.setToken(accessToken.getToken());
        accessTokenOutDto.setSecret(accessToken.getSecret());
        return accessTokenOutDto;
    }

    public static void showProducts() {
        final String MAGENTO_API_KEY = "8a96w87dedy0rr5wlt8jetacdzx6dnsv";
        final String MAGENTO_API_SECRET = "9jgh6zru6yo7ojnp1awhnzcllrx8cdjf";
        final String MAGENTO_ACCESS_KEY = "eaui9q653ml9j5ktmx1q4hmb7osuynmk";
        final String MAGENTO_ACCESS_SECRET = "nmev697jq7hs62arcc7ix2kzypis2p4o";
        final String MAGENTO_REST_API_URL = "http://www.ewiderbuy.com/api/rest";
        OAuthService service = new ServiceBuilder().provider(new MagentoThreeLeggedOAuth("http://www.ewiderbuy.com/")).
                apiKey(MAGENTO_API_KEY).
                apiSecret(MAGENTO_API_SECRET).
                build();
        Token permanentToken = new Token(MAGENTO_ACCESS_KEY, MAGENTO_ACCESS_SECRET);
        OAuthRequest request = new OAuthRequest(Verb.GET, MAGENTO_REST_API_URL+ "/orders/33");
       // OAuthRequest request = new OAuthRequest(Verb.GET, MAGENTO_REST_API_URL+ "/products?limit=101");
...
//        getAcessToken("928eed172ebc499b2d801b57ef368f03", "98bdf0e669cdb3cc5e6a5599b82573fd", "2986424f6429b288f6708aaabf33fadf");
    ...
    public static void testShowProducts() {
        ...
        OAuthService service = new ServiceBuilder().provider(new MagentoThreeLeggedOAuth("http://www.ewiderbuy.com/")).
                apiKey(MAGENTO_API_KEY).
                apiSecret(MAGENTO_API_SECRET).//callback("http://www.ewiderbuy.com/oauth_admin.php").
                build();
        ...
        OAuthRequest request = new OAuthRequest(Verb.GET, MAGENTO_REST_API_URL + "/orders");
...
//        // three-legged oauth
//        OAuthService magentoservice = new ServiceBuilder().
//                provider(MagentoThreeLeggedOAuth.class).
//                apiKey(MAGENTO_API_KEY).
//                apiSecret(MAGENTO_API_SECRET).
//                debug().build();
//        //OAuth10aServiceImpl magentoservice =(OAuth10aServiceImpl) new ServiceBuilder().provider(TestMage.MagentoThreeLeggedOAuth.class);
//
//        System.out.println("" + magentoservice.getVersion());
//        Scanner in = new Scanner(System.in);
...
//        String authorizationUrl = magentoservice.getAuthorizationUrl(requestToken);
...
//        System.out.println("Trading the Request Token for an Access Token...");
//
//        Token accessToken = magentoservice.getAccessToken(requestToken, verifier);
//        System.out.println("Got the Access Token!");
//        System.out.println("(if your curious it looks like this: "
//                + accessToken + " )");
//        System.out.println();
//
//        OAuthRequest request = new OAuthRequest(Verb.GET, MAGENTO_REST_API_URL + "/products", magentoservice);
//        magentoservice.signRequest(accessToken, request);
//
//        Response response = request.send();
//        System.out.println();
//        System.out.println(response.getCode());
