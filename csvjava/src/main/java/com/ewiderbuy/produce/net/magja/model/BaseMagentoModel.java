package com.ewiderbuy.produce.net.magja.model;

import com.ewiderbuy.produce.net.magja.utils.PropertyLoader;
import com.ewiderbuy.produce.net.magja.utils.PropertyLoader;
...
public abstract class BaseMagentoModel<S> implements Serializable {
  ...
  protected void loadMappings() {
    ...
    className = className.replace("com.ewiderbuy.produce.","");
