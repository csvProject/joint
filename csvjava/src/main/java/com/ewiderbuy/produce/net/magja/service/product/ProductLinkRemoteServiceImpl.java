...
public class ProductLinkRemoteServiceImpl extends GeneralServiceImpl<ProductLink> implements ProductLinkRemoteService {
  ...
  private ProductLink buildProductLink(Map<String, Object> map, ProductLink.LinkType linkType) {
  ...
  public Set<ProductLink> list(Product product) throws ServiceException {
    ...
    for (ProductLink.LinkType linkType : ProductLink.LinkType.values()) {
  ...
  @Override
  public Set<ProductLink> list(ProductLink.LinkType linktype, Product product) throws ServiceException {
