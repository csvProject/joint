 ...
 */
package com.ewiderbuy.produce.net.magja.service.cart;

import com.ewiderbuy.produce.net.magja.magento.ResourcePath;
import com.ewiderbuy.produce.net.magja.model.cart.Cart;
import com.ewiderbuy.produce.net.magja.model.cart.CartAddress.Type;
import com.ewiderbuy.produce.net.magja.model.cart.CartLicense;
import com.ewiderbuy.produce.net.magja.model.cart.CartTotal;
...
import com.ewiderbuy.produce.net.magja.model.cart.Cart;
import com.ewiderbuy.produce.net.magja.model.cart.CartAddress;
import com.ewiderbuy.produce.net.magja.model.cart.CartTotal;
import com.ewiderbuy.produce.net.magja.model.product.Product;
import com.ewiderbuy.produce.net.magja.service.ServiceException;
import com.ewiderbuy.produce.net.magja.soap.SoapClient;
...
public class CartRemoteServiceImpl extends GeneralServiceImpl<Cart> implements CartRemoteService {
  ...
  public void setAddresses(Cart cart) throws ServiceException {
    try {
      ...
      cart.getShippingAddress().setType(CartAddress.Type.Shipping);
      cart.getBillingAddress().setType(CartAddress.Type.Billing);
