...
import com.ewiderbuy.produce.net.magja.model.product.ProductAttribute;
import com.ewiderbuy.produce.net.magja.model.product.ProductAttributeSet;
import com.ewiderbuy.produce.net.magja.model.product.ProductType;
...
import com.ewiderbuy.produce.net.magja.utils.MagjaStringUtils;
import com.ewiderbuy.produce.net.magja.model.product.ProductType;
...
public class ProductAttributeRemoteServiceITest {
  ...
  /**
   * Test method for
   * {@link net.magja.service.product.ProductAttributeRemoteServiceImpl#delete(String)}
   * .
   *
  ...
  /**
   * Test method for
   * {@link net.magja.service.product.ProductAttributeRemoteServiceImpl#addOption(net.magja.model.product.ProductAttribute, String)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link net.magja.service.product.ProductAttributeRemoteServiceImpl#getByCode(String)}
   * .
   */
  @Test
