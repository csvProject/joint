package com.csv.java.net.magja.util;
...
import com.csv.java.net.magja.model.category.Category;
import com.csv.java.net.magja.model.customer.Customer;
import com.csv.java.net.magja.model.customer.Customer.Gender;
import com.csv.java.net.magja.model.customer.CustomerAddress;
import com.csv.java.net.magja.model.media.Media;
import com.csv.java.net.magja.model.product.Product;
import com.csv.java.net.magja.model.product.ProductMedia;
import com.csv.java.net.magja.model.product.Visibility;
import com.csv.java.net.magja.service.ServiceException;
import com.csv.java.net.magja.service.product.ProductRemoteService;
